...
class CynicSerialiserTest extends SerialiserTestBase
{
    public function testSetGetRequestRoundTrip()
    {
        ...
        $foo = new CynicSerialiser($mockService, $oldRequest);
    ...
    public function testSetService()
    {
        ...
        $foo = new CynicSerialiserDummy($mockService, null);
    ...
    public function testGenerateNextLinkUrlNeedsPlainSkippage()
    {
        ...
        $foo = m::mock(CynicSerialiserDummy::class)->shouldAllowMockingProtectedMethods()->makePartial();
